...
qv <- ggplot(outliers, aes(x=ID, y=-log10(PCA.q.val))) +
  ...
  geom_point(data=subset(outliers, PCA_outlier=="TRUE"), mapping=aes(color = "blue"), size = 0.9, alpha = 0.4) +
    geom_point(data=subset(outliers, BAYES_outlier=="TRUE"), mapping=aes(color="red"), size=0.9, alpha = 0.4) +
  #  geom_point(data=subset(outliers, BAYES_outlier=="TRUE" & PCA_outlier=="TRUE"), mapping=aes(color="#D55E00"), size=0.8) +
  theme_bw() +
  labs(x="SNP ID #", y="-log10(q-value)") +
  theme(legend.position = "bottom",
  ...
  scale_colour_manual(values = c("blue", "red"),
                      labels = c("PCAdapt", "BayeScan"), name = c("Outlier Type")) 
qv
...
#ggsave("~/Desktop/PhD/chapters/chapter 3 - fitti/figs_06122020/facelifted_figs/Fig_5_manhattanplot_total.pdf", total, height = 5, width = 8, units = "in")
