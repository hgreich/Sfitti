...
# these samples are HQ (qual over 200 and mm90) and were subsetted to match the spring 2018 genotyping set of snps that were called with both snp callers. Coral contam scaffolds removed
